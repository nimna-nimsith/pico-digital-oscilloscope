...
Getting started
Install the Arduino-Pico core in the Arduino IDE.
Install the Adafruit_GFX and Adafruit_ST7735 libraries via the Library Manager.
Wire the hardware as described above.
Open pico_oscilloscope.ino, select your Pico board, and upload.
Notes on accuracy
